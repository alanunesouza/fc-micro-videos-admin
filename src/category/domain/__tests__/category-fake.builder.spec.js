...
const category_fake_builder_1 = require("../category-fake.builder");
...
describe('CategoryFakerBuilder Unit Tests', () => {
    describe('category_id prop', () => {
        const faker = category_fake_builder_1.CategoryFakeBuilder.aCategory();
        ...
        test('withUuid', () => {
            const category_id = new uuid_vo_1.Uuid();
            const $this = faker.withUuid(category_id);
            expect($this).toBeInstanceOf(category_fake_builder_1.CategoryFakeBuilder);
        ...
        test('should pass index to category_id factory', () => {
            let mockFactory = jest.fn(() => new uuid_vo_1.Uuid());
            faker.withUuid(mockFactory);
            faker.build();
            expect(mockFactory).toHaveBeenCalledTimes(1);
            const categoryId = new uuid_vo_1.Uuid();
            mockFactory = jest.fn(() => categoryId);
            const fakerMany = category_fake_builder_1.CategoryFakeBuilder.theCategories(2);
    ...
    describe('created_at prop', () => {
        const faker = category_fake_builder_1.CategoryFakeBuilder.aCategory();
        test('should throw error when any with methods has called', () => {
            const fakerCategory = category_fake_builder_1.CategoryFakeBuilder.aCategory();
    ...
    test('should create many categories', () => {
        const faker = category_fake_builder_1.CategoryFakeBuilder.theCategories(2);
