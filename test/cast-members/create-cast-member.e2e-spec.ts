...
import { InterfaceCastMemberRepository } from '../../src/core/cast-member/domain/cast-member.repository';
import { CastMemberId } from '../../src/core/cast-member/domain/cast-member.entity';
...
describe('CastMembersController (e2e)', () => {
  describe('/cast-members (POST)', () => {
    ...
    describe('should create a cast member', () => {
      ...
      let castMemberRepo: InterfaceCastMemberRepository;
      beforeEach(async () => {
        castMemberRepo = app.app.get<InterfaceCastMemberRepository>(
